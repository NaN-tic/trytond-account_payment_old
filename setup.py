...
setup(name='trytonzz_account_payment',
    version=info.get('version', '0.0.1'),
    description='Tryton module to manage invoice payments and automated payments',
    author='Zikzakmedia SL',
    author_email='zikzak@zikzakmedia.com',
    url='http://www.zikzakmedia.com',
    download_url="https://bitbucket.org/zikzakmedia/trytond-account_payment",
